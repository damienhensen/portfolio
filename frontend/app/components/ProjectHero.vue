  ...
  <section class="py-12 lg:pt-24">
    ...
    >
      <div class="max-w-3xl">
        ...
        <p class="mt-4 max-w-2xl">{{ project.description }}</p>
      </div>

      <div
        class="flex flex-col gap-4 text-center uppercase sm:flex-row lg:shrink-0"
        v-if="project.demo?.live || project.demo?.source"
      >
        <NuxtLink
