<template>
  <section class="border-border flex border-y py-8">
    <div
    ...
    >
      ...
      <div class="max-w-2xl p-8">
        ...
        <div class="mb-4 flex flex-col gap-2">
          <p>
            Outside of software development, I enjoy gaming, anime, and working
            on personal projects that help me learn something new.
          </p>

          <p>
            Whether it's building applications, automating workflows, or
            experimenting with new technologies, I enjoy creating things and
